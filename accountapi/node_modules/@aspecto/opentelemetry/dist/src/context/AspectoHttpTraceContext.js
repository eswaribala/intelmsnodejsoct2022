...
exports.AspectoHttpTraceContext = exports.parseTraceParent = exports.TRACE_STATE_HEADER = exports.ASPECTO_TRACE_PARENT_HEADER = exports.TRACE_PARENT_HEADER = void 0;
const api_1 = require("@opentelemetry/api");
const core_1 = require("@opentelemetry/core");
exports.TRACE_PARENT_HEADER = 'traceparent';
exports.ASPECTO_TRACE_PARENT_HEADER = 'aspecto-traceparent';
...
function tryTraceParentHeader(carrier, getter, header) {
...
class AspectoHttpTraceContext {
    inject(context, carrier, setter) {
        ...
        setter.set(carrier, exports.ASPECTO_TRACE_PARENT_HEADER, traceParent);
        if (spanContext.traceState) {
            setter.set(carrier, exports.TRACE_STATE_HEADER, spanContext.traceState.serialize());
        }
    }
    extract(context, carrier, getter) {
        let spanContext = tryTraceParentHeader(carrier, getter, exports.ASPECTO_TRACE_PARENT_HEADER);
        if (!spanContext) {
            spanContext = tryTraceParentHeader(carrier, getter, exports.TRACE_PARENT_HEADER);
            if (!spanContext)
                return context;
        }
    ...
    fields() {
        return [exports.TRACE_PARENT_HEADER, exports.ASPECTO_TRACE_PARENT_HEADER, exports.TRACE_STATE_HEADER];
    }
}
exports.AspectoHttpTraceContext = AspectoHttpTraceContext;
//# sourceMappingURL=AspectoHttpTraceContext.js.map